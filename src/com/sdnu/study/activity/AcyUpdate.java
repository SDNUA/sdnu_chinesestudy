...
import com.sdnu.study.myUtils.Common;

public class AcyUpdate extends Activity {
	...
	String m_appNameStr = "better.apk"; // 下载到本地要给这个APP命的名字

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.acyupdate_layout);
		// loadData();
		initView();
	}

	private void initView() {
		tvContent = (TextView) this.findViewById(R.id.tvUpdateContent);
				...
				.setPositiveButton("更新",// 设置确定按钮
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								downFile(Model.UPDATESOFTADDRESS); // 开始下载
							}
						})
